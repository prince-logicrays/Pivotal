    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            ...
            [
                ...
                //phpcs:ignore
                'note'     => __('For internal use. Must be unique with no spaces. Please use only lowercase letters and underscores. It is not recommended to use digits, other symbols or uppercase letters since it may cause unwanted issues or undesired behavior and break the import functionality.'),
                'class'    => 'validate-code',
                'required' => true,
            ]
        );
    ...
    private function addFrontendPropertiesFields(&$fieldset, $yesno)
    {
        $fieldset->addField(
            ...
            [
                ...
                'note'   => __('Attribute names and attribute values will not be counted '
                    . 'as Keywords for "Search by keyword" feature'),
                'values' => $yesno,
            ]
        );
        ...
        $fieldset->addField(
            ...
            [
                ...
                'label'  => __('Show on the Shipping page'),
                'title'  => __('Show on the Shipping page - during Checkout'),
        ...
        $fieldset->addField(
            ...
            [
                'name'   => 'billing_filled',
                'label'  => __('Hide if Filled'),
                'title'  => __('Hide if Filled - During Checkout'),
                'note'   => __('During Checkout for registered customers'),
                'values' => $yesno
            ]
        );
